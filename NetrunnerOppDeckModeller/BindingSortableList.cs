...
{
    public class BindingSortableList<T> : BindingList<T>
    {
        ...
        Action<BindingSortableList<T>, List<T>>
        ...
        public BindingSortableList()
        {
            originalList = new List<T>();
        }

        public BindingSortableList(IEnumerable<T> enumerable)
        {
            originalList = enumerable.ToList();
            populateBaseList(this, originalList);
        }

        public BindingSortableList(List<T> list)
        {
            originalList = list;
            populateBaseList(this, originalList);
        }
